...
const Time = () => {
    ...
    const getRandomNum = useCallback((min: number, max: number): string => {
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            {headColumns.map(headColumn => <TableHeadCell>{headColumn}</TableHeadCell>)}
                            <TableHeadTitleCell style={{paddingLeft: 8, width: 81}}>Total</TableHeadTitleCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        <TableRow>
